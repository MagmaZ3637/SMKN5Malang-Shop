<x-skeleton judul="Login">
    <div class="bg-linear-to-r from-white to-blue-100 flex items-center justify-center min-h-screen p-4 kedebideri-medium">
                ...
                <form class="space-y-4" method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <div class="relative w-full">
                            <input type="password" name="password" class="pass w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500" placeholder="Masukkkan password anda">
                            <button type="button"
                    ...
                    <p class="text-gray-400">Belum punya akun? <a href="{{ url('/register') }}" class="text-blue-300 hover:text-blue-600">daftar sekarang</a></p>
